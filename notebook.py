...
class Note:
    ...
    string in searches and store tags for each.'''
...
class Notebook:
    ...
    def modify_tags(self, note_id, tags):
         '''Find the note with the given id and change it tag to the given value'''
         for note in self.notes:
             if note_id == note_id:
                 note.tags = tag
                 break
    ...
    def search(self, filter):
         ...
         return [note for note in self.notes if note.mach(filter)]
